...
class TrajectoryPublisher(TemplatePublisher):
    ...
    def __init__(self, bag: str, topic: str):
        """Initialize handler."""

        # load rosbag
        self.traj_info = get_trajectory_info(bag, topic)
...
def get_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Publish trajectory information."
    )
    parser.add_argument(
        "bag", type=str,
        help="Target rosbag."
...
if __name__ == '__main__':
    ...
    handler = TrajectoryPublisher(args.bag, args.topic)
